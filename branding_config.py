...
DEFAULT_OWNER_NAME = "Đình Nam Automation"
DEFAULT_OWNER_PHONE = "0346.259.826"

OWNER_ZALO_URL = "https://zalo.me/g/xkiexb851"
...
def _apply_owner_values(owner_name: str, owner_phone: str):
    ...
    WINDOW_TITLE = f"VIDEO GENERATOR PRO ({APP_VERSION}) - {OWNER_NAME} - {OWNER_PHONE_LABEL}"
