    ...
    *,
    ...
    parts.extend(
        [
            ...
            "For comic/manga sources: treat the source as panel/page material; infer a visual sequence from narration, dialogue, captions, page order, and panel descriptions. Preserve the story flow, character roles, key actions, and emotional beats, but output scenes in the selected or auto-detected app style.",
            "The final visual look is controlled only by the selected/auto-detected output style in the app. Do not preserve the source medium unless it matches that selected style.",
