...
from src.core.settings_manager import SettingsManager, WORKFLOWS_DIR, PROJECT_DATA_FILE
...
class TokenCollector:
    ...
    async def get_token(self, clear_storage=False, token_timeout_override=None):
        ...
        async with self._token_lock:
            return await self._get_token_internal(clear_storage, token_timeout_override)

    async def _get_token_internal(self, clear_storage=False, token_timeout_override=None):
