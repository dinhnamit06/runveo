...
class GrokSettingsTab(QWidget):
    def __init__(self, config, parent: QWidget | None = None):
        ...
        lb_account_type.setStyleSheet('font-weight:700; color:#f8fafc;')
        lb_length = QLabel('Thời gian video:')
        lb_length.setStyleSheet('font-weight:700; color:#f8fafc;')
        lb_resolution = QLabel('Chất lượng video:')
        lb_resolution.setStyleSheet('font-weight:700; color:#f8fafc;')
        lb_multi = QLabel('MULTI VIDEO:')
        lb_multi.setStyleSheet('font-weight:700; color:#f8fafc;')
        ...
        note.setStyleSheet('color:#94a3b8; font-size:12px; line-height:1.45; background:#1e293b; border:1px solid #334155; border-radius:8px; padding:10px;')
        body.addWidget(note)
    ...
    def _show_profile_popup(self, profile_dir: str, host: str, port: int) -> None:
        ...
        status.setStyleSheet('color:#f1f5f9; font-size:12px; background:#1e293b; border:1px solid #334155; border-radius:8px; padding:8px;')
