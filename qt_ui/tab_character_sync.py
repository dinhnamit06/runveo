...
class _DropArea(QFrame):
    def __init__(self, tab: 'CharacterSyncTab'):
        ...
        self._empty.setStyleSheet('color:#94a3b8; font-weight:600;')
...
class _CharacterCard(QWidget):
    def __init__(self, tab: 'CharacterSyncTab', idx: int, path: str, name: str):
        ...
        self._img.setStyleSheet('background:#1e293b; border:1px solid #334155; border-radius:8px;')
        ...
        btn.setStyleSheet('background:#475569; color:white; border:none; border-radius:11px;font-weight:900; font-size:16px;')
...
class CharacterSyncTab(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.drop.setStyleSheet('QFrame#DropArea{border:1px dashed #334155; border-radius:10px; background:#1e293b;}')
