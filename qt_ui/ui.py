...
def apply_style(app: QApplication) -> None:
    ...
    QPushButton#TopAction:hover { background: #312e81; }
    ...
    QPushButton#DangerSoft:hover { background: #7f1d1d; }

    QPushButton#Accent { background: #4f46e5; border-color: #6366f1; color: white; }
    QPushButton#Accent:hover { background: #4338ca; }
    
    QPushButton#Success { background: #059669; border-color: #10b981; color: white; }
    QPushButton#Success:hover { background: #047857; }
    
    QPushButton#Warning { background: #d97706; border-color: #f59e0b; color: white; }
    QPushButton#Warning:hover { background: #b45309; }
    
    QPushButton#Orange { background: #ea580c; border-color: #f97316; color: white; }
    QPushButton#Orange:hover { background: #c2410c; }
    
    QPushButton#Danger { background: #dc2626; border-color: #ef4444; color: white; }
    ...
    QPushButton#Zalo:hover { background: #0c4a6e; }
...
class MainWindow(QMainWindow):
    def __init__(self, config: AppConfig):
        ...
        self.tab_create_image = CreateImageTab(config=self._cfg, on_model_changed=self._on_create_image_model_changed)
        self.tab_idea = IdeaToVideoTab(config=self._cfg)
        self.tab_settings = SettingsTab(config=self._cfg)
