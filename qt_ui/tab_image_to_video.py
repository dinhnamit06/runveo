...
class _SingleImageTab(QWidget):
    def __init__(self, parent: QWidget | None = None):
        ...
        step1.setStyleSheet('font-weight: 600; color: #f8fafc;')
        ...
        step2.setStyleSheet('font-weight: 600; color: #f8fafc;')
    ...
    def _build_image_cell(self, idx: int, path: str) -> tuple[QWidget, int]:
        ...
        if path:
            btn_name.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center;color:#94a3b8; font-size:10px; font-weight:600;}')
        else:
            btn_name.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center;color:#6366f1; font-size:12px; font-weight:800;}')
        ...
        btn_del.setStyleSheet('background:#450a0a; border:1px solid #991b1b; border-radius:11px;color:#f87171; font-weight:400; font-size:14px; padding:0px;')
...
class _StartEndImageTab(QWidget):
    def __init__(self, parent: QWidget | None = None):
        ...
        step3.setStyleSheet('font-weight: 600; color: #f8fafc;')
    ...
    def _build_image_cell(self, idx: int, path: str, role: str='start') -> tuple[QWidget, int]:
        ...
        if path:
            name_btn.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center;color:#94a3b8; font-size:10px; font-weight:600;}')
        else:
            name_btn.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center;color:#6366f1; font-size:12px; font-weight:800;}')
